...
func (_m *AuthRepoInterface) Login(user entities.User) (entities.User, error) {
	ret := _m.Called(user)
...
func (_m *AuthRepoInterface) Register(user entities.User) (entities.User, error) {
	ret := _m.Called(user)
...
func NewAuthRepoInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *AuthRepoInterface {
